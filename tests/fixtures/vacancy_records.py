...
ONSITE_OUTSIDE_TBILISI = record(
    "Business Analyst", "<p>Onsite in Berlin office. Requirements analysis.</p>", jobGeo="Berlin, Germany"
)
HYBRID_TBILISI = record(
    "Systems Analyst",
    "<p>Hybrid in Tbilisi, Georgia. Systems analysis and integrations.</p>",
    jobGeo="Tbilisi, Georgia",
)
RUSSIAN_ROLE = record("Системный аналитик", "<p>Тбилиси удаленно. Анализ требований и документация.</p>")
GEORGIAN_AUTH = record(
    "Business Systems Analyst", "<p>Remote role. Work authorization in Georgia is required. Requirements analysis.</p>"
)
