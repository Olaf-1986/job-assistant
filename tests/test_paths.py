...
def test_output_paths_preserve_configured_keys_and_filenames(tmp_path):
    ...
    expected_filenames = {
        ...
        "headhunter_shortlist": outputs.headhunter_shortlist_file,
        "linkedin_shortlist": outputs.linkedin_shortlist_file,
        ...
        "deduplicated_shortlist": outputs.deduplicated_shortlist_file,
        "previous_combined_shortlist": outputs.previous_combined_shortlist_file,
        "recovered_state": "recovered_shortlist_state.json",
